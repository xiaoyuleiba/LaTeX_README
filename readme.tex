...
\begin{enumerate}	
	...
	\begin{enumerate}
		...
		\begin{enumerate}		
			...
			\item \verb|doi=true|: 类似于超链接, 可选择表示\verb|DOI|号
			\item \verb|dateabbrev=true|: 出版日期中的月份是否简写, 类似于\verb|November|简写为\verb|Nov.|;
			\item \verb|backref=true|: 可选择在参考文献条目后生成一个超链接style=numeric-comp,maxnames=15|
		\end{enumerate}
	\end{enumerate}
...
\end{align*}
\subitem 其中的\verb|\!|, \verb|\,|, \verb|\:|, \verb*|\ |, \verb|\quad|, \verb|\qquad|即为字符间距设置命令.\cite{alum}
\subitem 注意到:
\begin{itemize}
