...
\begin{itemize}
	...
	\subitem subitem样式 (itemize-subitem) 
		...
		\subitem subitem样式 (itemize-itemize-subitem) 
		\subsubitem subsubitem样式 (itemize-itemize-subitem-subsubitem) 
			\begin{itemize}
			\item 第3层\verb|itemize|
			\subitem subitem样式 (itemize-itemize-itemize-subitem) 
			\subsubitem subsubitem样式 (itemize-itemize-itemize-subitem-subsubitem) 
				\begin{itemize}
				\item 第4层\verb|itemize|
				\subitem subitem样式 (itemize-itemize-itemize-itemize-subitem) 
				\subsubitem subsubitem样式 (itemize-itemize-itemize-itemize-subitem-subsubitem) 
					\begin{enumerate}
						\item 第1层\verb|enumerate|
						\subitem subitem样式 (itemize-itemize-itemize-itemize-enumerate-subitem) 
						\subsubitem subsubitem样式 (itemize-itemize-itemize-itemize-enumerate-subitem-subsubitem) 
							\begin{enumerate}
